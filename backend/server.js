...
//client.query("CREATE TABLE Laboratorio ( id_Laboratorio char(15), nombre char(20), descripcion char(30), ubicacion char(20), capacidad numeric(9,0), PRIMARY KEY (id_Laboratorio))");
